...
I think we should change the title of the standards sheet, “Ingalls_Lab_Standards_NEW.csv” to just “Ingalls_Lab_Standards.csv”, as I have done in these examples. I originally added the “NEW” suffix during my first redo of the standards and it doesn’t make sense to keep it permanently.
The column order is redone, take a look to see if it makes sense.
I dropped the QE and TQS LinRange, RSD, Ratio columns.
Renamed all column to use consistent underscores instead of a mix of underscores and periods, changed all columns that refer to third party ids to “Database_ID”,  e.g. “C0” is now “KEGG_ID”.
Added a “PubChem_ID” column.
Removed the “ChEBI:” and “cpd:” prefixes in the KEGG and ChEBI columns.

Yay!! This looks awesome - thanks so much for doing all the cleaning. A few more comments (per usual): "emperical" formula is misspelled (I think this has always been the case but now's our chance to fix it); I think we should keep the ChEBI prefixes (I've never seen them as just the number); and InCHI and SMILES would be more accurately described as "codes" rather than names (love the suffix consistency though!)
...
My_KEGG_File <- "KEGG_Compounds_02-Aug-2021"
...
My_ChEBI_File <- "ChEBI_Download_28-Jul-2021"
